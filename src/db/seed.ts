...
import { db } from ".";
import { categoryTable, colorEnum, productTable, productVariantTable } from "./schema";
    ...
    for (const productData of products) {
      ...
      for (const variantData of productData.variants) {
        ...
        await db.insert(productVariantTable).values({
          name: variantData.color as typeof colorEnum.enumValues[number],
          productId: productId,
          color: variantData.color as typeof colorEnum.enumValues[number],
